...
public class Game extends Thread {
    ...
    private Image gameInfoImage = new ImageIcon(Main.class.getResource("gameInfo.png")).getImage();
    private Image judgementLineImage = new ImageIcon(Main.class.getResource("judgementLine.png")).getImage();
    private Image noteRouteLineImage = new ImageIcon(Main.class.getResource("noteRouteLine.png")).getImage();
    //每个按键控制一个区域
    private Image noteRouteSImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    private Image noteRouteDImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    private Image noteRouteFImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    private Image noteRouteSpaceImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    private Image noteRouteJImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    private Image noteRouteKImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    private Image noteRouteLImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    ...
    public void screenDraw(Graphics2D g) {
        ...
        for (int i = 0; i < noteList.size(); i++) {
            ...
            if (note.getY() > 960){
                judgeImage = new ImageIcon(Main.class.getResource("judgeMiss.png")).getImage();
            }
            if (!note.isProceeded()){
                noteList.remove(i);
                i--;
    ...
    public void pressS() {
        judge("S");
        noteRouteSImage = new ImageIcon(Main.class.getResource("noteRoutePressed.png")).getImage();
        new Music("PressedKeyboardMusic.mp3", false).start();
    }

    public void releaseS() {
        noteRouteSImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    }

    //D
    public void pressD() {
        judge("D");
        noteRouteDImage = new ImageIcon(Main.class.getResource("noteRoutePressed.png")).getImage();
        new Music("PressedKeyboardMusic.mp3", false).start();
    }

    public void releaseD() {
        noteRouteDImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    }

    //F
    public void pressF() {
        judge("F");
        noteRouteFImage = new ImageIcon(Main.class.getResource("noteRoutePressed.png")).getImage();
        new Music("PressedKeyboardMusic.mp3", false).start();
    }

    public void releaseF() {
        noteRouteFImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    }

    //Space
    public void pressSpace() {
        judge("Space");
        noteRouteSpaceImage = new ImageIcon(Main.class.getResource("noteRoutePressed.png")).getImage();
        new Music("PressedKeyboardMusic.mp3", false).start();
    }

    public void releaseSpace() {
        noteRouteSpaceImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    }

    //J
    public void pressJ() {
        judge("J");
        noteRouteJImage = new ImageIcon(Main.class.getResource("noteRoutePressed.png")).getImage();
        new Music("PressedKeyboardMusic.mp3", false).start();
    }

    public void releaseJ() {
        noteRouteJImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    }

    //K
    public void pressK() {
        judge("K");
        noteRouteKImage = new ImageIcon(Main.class.getResource("noteRoutePressed.png")).getImage();
        new Music("PressedKeyboardMusic.mp3", false).start();
    }

    public void releaseK() {
        noteRouteKImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    }

    //L
    public void pressL() {
        judge("L");
        noteRouteLImage = new ImageIcon(Main.class.getResource("noteRoutePressed.png")).getImage();
        new Music("PressedKeyboardMusic.mp3", false).start();
    }

    public void releaseL() {
        noteRouteLImage = new ImageIcon(Main.class.getResource("noteRoute.png")).getImage();
    }
...
//                    new Beat(startTime + gap * 86, "J"),
    ...
    public void judgeEvent(String judge){
        if (!judge.equals("None")){
            blueFlareImage = new ImageIcon(Main.class.getResource("blueFlare.png")).getImage();
        }
        if(judge.equals("Miss")){
            judgeImage = new ImageIcon(Main.class.getResource("judgeMiss.png")).getImage();
        }
        else if(judge.equals("Late")){
            judgeImage = new ImageIcon(Main.class.getResource("judgeLate.png")).getImage();
        }
        else if(judge.equals("Early")){
            judgeImage = new ImageIcon(Main.class.getResource("judgeEarly.png")).getImage();
        }
        else if(judge.equals("Good")){
            judgeImage = new ImageIcon(Main.class.getResource("judgeGood.png")).getImage();
        }
        else if(judge.equals("Prefect")){
            judgeImage = new ImageIcon(Main.class.getResource("judgePrefect.png")).getImage();
        }
    }
